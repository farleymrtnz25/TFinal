document.addEventListener('DOMContentLoaded', function() {
    const API_URL_TRABAJADORES = 'https://licoreria.netlify.app/.netlify/functions/api/trabajadores';
    const API_URL_INVENTARIO = 'https://licoreria.netlify.app/.netlify/functions/api/inventario';
